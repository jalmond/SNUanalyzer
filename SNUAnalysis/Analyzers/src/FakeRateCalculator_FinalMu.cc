/***************************************************************************
 * @Project: SNUFakeRateCalculator_FinalMu Frame - ROOT-based analysis framework for Korea SNU
...
void FakeRateCalculator_FinalMu::InitialiseAnalysis() throw( SNUError ) {
...
void FakeRateCalculator_FinalMu::ExecuteEvents()throw( SNUError ){
...
void FakeRateCalculator_FinalMu::EndCycle()throw( SNUError ){
...
void FakeRateCalculator_FinalMu::BeginCycle() throw( SNUError ){
...
void FakeRateCalculator_FinalMu::BeginEvent( )throw( SNUError ){
...
void FakeRateCalculator_FinalMu::ClearOutputVectors() throw(SNUError) {
