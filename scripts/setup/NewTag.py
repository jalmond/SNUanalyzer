...
path_newtag =  str(os.getenv("ANALYZER_DIR" )) + "/scripts/setup/git_newtag.sh"
...
for line in file_newtag:
    if "itag=" in line:
        ...
        if len(sline) == 1:
            sline = sline[0]
            sline = sline[6:-1]
            newtag= str(os.getenv("SNUVERSION")) + str(sline)

file_newtag.close()

os.system("source " +  str(os.getenv("ANALYZER_DIR" )) + "/scripts/setup/git_newtag.sh")
...
path_file_email="/data2/SNU_SKTreeOutput/" + os.getenv("USER")  + "/email_newtag.sh"
file_email=open(path_file_email,"w")
file_email.write('cat /data2/SNU_SKTreeOutput/' + os.getenv("USER")  + '/email_newtag.txt | mail -s "New SNUANALYZER tag ' + newtag + '" ' +str(email_user)+'')
file_email.close()

filejobsummary = open("/data2/SNU_SKTreeOutput/" + os.getenv("USER")  + "/email_newtag.txt","w")
filejobsummary.write("SNUAnalyzer Tag Name: " + newtag +"\n")
...
os.system("bash " + os.getenv("ANALYZER_DIR")+"/bin/submitSKTree.sh -D " + os.getenv("SNUVERSION") + "> log")
...
filejobsummary.write("_"*60+"\n")
filejobsummary.write("\n")
filejobsummary.write("SNUANALYZER TAG CHANGELOG::\n")
path_log = "/data1/Analyzer_rootfiles_for_analysis/SNUTag/TagDiff_"+newtag+".txt"
...
filejobsummary.write("cd $ANALYZER_DIR\n")
...
filejobsummary.write("https://twiki.cern.ch/twiki/bin/viewauth/CMS/SNUNtuples#v8_0_2\n")
filejobsummary.write("\n")
filejobsummary.write("_"*60)
filejobsummary.write("\n")
...
filejobsummary.write("SNUTUPLE("+os.getenv("SNUVERSION")+") GOOGLEDOC https://docs.google.com/spreadsheets/d/1rWM3AlFKO8IJVaeoQkWZYWwSvicQ1QCXYSzH74QyZqE/edit?alt=json#gid=1895591332\n")
...
filejobsummary.write("SNUTop https://twiki.cern.ch/twiki/bin/viewauth/CMS/SNUToolsTopAnalysis\n")
filejobsummary.write("\n")
filejobsummary.write("_"*60+"\n")
filejobsummary.write("\n")
filejobsummary.write("Latest file list (used by sktree in SNUANALYZER): \n")

path_filelist = "/data1/SNUAnalyzer_rootfiles_for_analysis/DataSetLists/AnalysisFiles/datasets_snu_SNU_mc_"+os.getenv("SNUVERSION") +".txt"
