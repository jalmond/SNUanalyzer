...
class BaseSelection {
 ...
 public:
  ...
  enum ID {
    ...
    ELECTRON_HctoWA_FAKELOOSE      = 9,
    ELECTRON_HN_VETO               = 10,
    ELECTRON_HN_TIGHT              = 11,
    ELECTRON_HN_FAKELOOSE          = 12,
    ELECTRON_HN_FAKELOOSE_NOD0     = 13,
    ELECTRON_HN_MVA_LOOSE          = 14,
    ELECTRON_HN_MVA_TIGHT          = 15,
    ELECTRON_TOP_VETO              = 16,
    ELECTRON_TOP_LOOSE             = 17,
    ELECTRON_TOP_TIGHT             = 18,
    ELECTRON_PTETA                 = 19,
    ELECTRON_NOCUT                 = 20,
    MUON_POG_LOOSE                 = 21,
    MUON_POG_MEDIUM                = 22,
