...
public :
   ...
   std::string GetSNUVersion(bool runSNU);
   void SetSNUVersion(std::string cv);
   ...
   std::vector<bool>    *HLT_TriggerFired;
   std::vector<int>     *HLT_TriggerPrescale;
   ...
   std::vector<bool>    *electron_passVetoID;
   std::vector<bool>    *electron_passLooseID;
   std::vector<bool>    *electron_passMediumID;
   std::vector<bool>    *electron_passTightID;
   std::vector<bool>    *electron_passMVAID_noIso_WP80;
   std::vector<bool>    *electron_passMVAID_noIso_WP90;
   std::vector<bool>    *electron_passMVAID_iso_WP80;
   std::vector<bool>    *electron_passMVAID_iso_WP90;
   ...
   std::vector<double>  *pfMET_Px_shifts;
   std::vector<double>  *pfMET_Py_shifts;
   std::vector<double>  *pfMET_SumEt_shifts;
   std::vector<double>  *pfMET_Type1_pt_shifts;
   std::vector<double>  *pfMET_Type1_phi_shifts;
   std::vector<double>  *pfMET_Type1_Px_shifts;
   std::vector<double>  *pfMET_Type1_Py_shifts;
   ...
   std::vector<double>  *pfMET_Type1_PhiCor_Px_shifts;
   std::vector<double>  *pfMET_Type1_PhiCor_Py_shifts;
